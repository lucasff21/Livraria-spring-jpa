...
import lucas.livraria.projeto.services.UserService;
...
public class UserResource {
	...
	@PostMapping
	public ResponseEntity<User> insert(@RequestBody User item){
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<User> update(@PathVariable Long id, @RequestBody User item){
